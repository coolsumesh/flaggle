  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      <div className="text-center mb-8">
        <h2 className="text-3xl sm:text-4xl font-bold mb-2">Flagle</h2>
        <p className="text-gray-600 text-sm sm:text-base">Guess the country from its flag in 6 attempts!</p>
      </div>
